      ...
      return Array.from(Array(this.state.itemNumber).keys()).reverse().map(function (i) {
        return _react2.default.createElement(
          _item2.default,
          {
            ...
            x: _this2.getX(i, x, children[i + 1] && angles[children[i + 1].key]),
            y: _this2.getY(i, y, children[i + 1] && angles[children[i + 1].key]),
            bumpy: bumpy,
